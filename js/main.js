$(function(){
    ...
    // $('.bakuretsu_dropdown').click(function(){
    //     $(this).children('.dropOptions').slideToggle('fast');
    //     $(this).toggleClass('activo');
    // })
    // $('.bakuretsu_dropdown .dropOptions .option').click(function(){
    //     let value = $(this).data('value');
    //     $(this).parents('.bakuretsu_dropdown').find('.currentValue').text(value);
    // })



    function fixedMenu(){
        let topMenu = $('.bakuretsu_menu').offset().top;
        let alturaMenu = $('.bakuretsu_menu').outerHeight();
        if($(window).scrollTop() >= topMenu) {
            $('.bakuretsu_menu').addClass('fixed');
            $('.bakuretsu_menu').css('height', alturaMenu);
        }else {
            $('.bakuretsu_menu').removeClass('fixed');
            $('.bakuretsu_menu').removeAttr('style');
        }
    }
